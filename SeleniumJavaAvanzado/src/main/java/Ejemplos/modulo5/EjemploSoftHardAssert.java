...
public class EjemploSoftHardAssert {
    ...
    @Test(description = "Creacion de una Clase", dataProvider = "SchoolProvider", enabled = false)
    ...
    void testToCreateClass(String ... classInfo){
        ...
        softAssert.assertEquals(classInfo[0], txtClassName.getAttribute("vale"));

        //Class Number
        driver.findElement(By.name("Number")).sendKeys(classInfo[1]);
        //Class Capacity
        driver.findElement(By.id("c_capacity")).sendKeys(classInfo[2]);
        softAssert.assertEquals(classInfo[2], "Capacity");
        // Teacher
    ...
    void testToCreateSubject(String className, String subjectName, String subjectCode, String subjectTeacher, String book){
        ...
        Assert.assertTrue(drpClass.getText().contains(className));
        ...
        Assert.assertTrue(txtSubjectCode.getAttribute("value").contains("Code"));
        //Teacher
