...
public class ItestContextDataProvider {
    WebDriver driver;
    ...
    Object[][] getSchoolDate(ITestContext groupContext){
        Object[][] groupArray = null;
        for (String group: groupContext.getIncludedGroups()){
    ...
    @Test(description = "Creacion de una Clase", dataProvider = "SchoolProvider", groups = "Smoke")
    ...
    @Test(description = "Crear una materia", dataProvider = "SchoolProvider", groups = "Regression")
